...
class Temp_Logs():
	...
	def import_data(self):
		stamp,n,t0,t0_err,t1,t1_err,t2,t2_err,t3,t3_err,t4,t4_err,t5,t5_err,t6,t6_err,t7,t7_err,comment = np.genfromtxt(self.filename,dtype=str,unpack=True,delimiter='\t')
		...
		temp_err = [t0_err,t1_err,t2_err,t3_err,t4_err,t5_err,t6_err,t7_err]
		
		return(date,time,n,temp,temp_err)
...
if __name__ == "__main__":
	...
	date,time,n,temp,temp_err = temp_logs.import_data()
	temp_logs.plot_data(date,time,n,temp,temp_err)
